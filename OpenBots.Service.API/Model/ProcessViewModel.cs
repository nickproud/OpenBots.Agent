...
namespace OpenBots.Service.API.Model
{
        ...
        public partial class ProcessViewModel :  IEquatable<ProcessViewModel>, IValidatableObject
    {
        ...
        public ProcessViewModel(Guid? id = default(Guid?), string name = default(string), int? version = default(int?), Guid? versionId = default(Guid?), DateTime? createdOn = default(DateTime?), string createdBy = default(string), string status = default(string), byte[] _file = default(byte[]), Guid? fileId = default(Guid?), Guid? organizationId = default(Guid?))
        {
