...
namespace OpenBots.Service.API.Model
{
        ...
        public partial class Body1 :  IEquatable<Body1>, IValidatableObject
    {
        ...
        public Body1(Guid? id = default(Guid?), string name = default(string), string type = default(string), string textValue = default(string), double? numberValue = default(double?), string jsonValue = default(string), Guid? fileID = default(Guid?), byte[] _file = default(byte[]), Guid? organizationId = default(Guid?))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
