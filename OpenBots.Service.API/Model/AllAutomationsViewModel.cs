...
namespace OpenBots.Service.API.Model
{
        ...
        public partial class AllAutomationsViewModel :  IEquatable<AllAutomationsViewModel>, IValidatableObject
    {
        ...
        public AllAutomationsViewModel(Guid? id = default(Guid?), string name = default(string), DateTime? createdOn = default(DateTime?), string createdBy = default(string), string status = default(string), int? versionNumber = default(int?))
        {
