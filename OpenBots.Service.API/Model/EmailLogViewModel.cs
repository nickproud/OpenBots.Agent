...
namespace OpenBots.Service.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmailLogViewModel :  IEquatable<EmailLogViewModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailLogViewModel" /> class.
        /// </summary>
        ...
        public EmailLogViewModel(Guid? id = default(Guid?), Guid? emailAccountId = default(Guid?), DateTime? sentOnUTC = default(DateTime?), string emailObjectJson = default(string), string senderAddress = default(string), Guid? senderUserId = default(Guid?), string status = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailLogViewModel {\n");
        ...
        {
            return this.Equals(input as EmailLogViewModel);
        }

        /// <summary>
        /// Returns true if EmailLogViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailLogViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailLogViewModel input)
        {
            if (input == null)
                return false;
