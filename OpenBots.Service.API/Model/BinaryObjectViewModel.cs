...
namespace OpenBots.Service.API.Model
{
        ...
        public partial class BinaryObjectViewModel :  IEquatable<BinaryObjectViewModel>, IValidatableObject
    {
        ...
        public BinaryObjectViewModel(Guid? id = default(Guid?), string name = default(string), Guid? organizationId = default(Guid?), string contentType = default(string), Guid? correlationEntityId = default(Guid?), string correlationEntity = default(string), string storagePath = default(string), string folder = default(string), string storageProvider = default(string), long? sizeInBytes = default(long?), string hashCode = default(string), byte[] _file = default(byte[]))
        {
            this.Id = id;
            this.Name = name;
